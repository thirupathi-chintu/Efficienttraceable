...
<div class="super_container">
	...
	<div class="home">
		...
		<div class="home_background parallax_background parallax-window" data-parallax="scroll" data-image-src="images/video.jpg" data-speed="0.8"></div>
		<div class="home_container">
			<div class="container">
				<div class="row">
					<div class="col">
                                            <div class="home_content text-center">
							<div class="home_title">User Login</div><br>
                                                        ...
                                                        String msg=request.getParameter("msg");
                                                            ...
                                                            out.println("alert('User Under Waiting Status...');");
                                                            out.println("</script>");  
                                                            ...
                                                            if(msg !=null && msg.equalsIgnoreCase("blocked"))
                                                            {
                                                            out.println("<script type=\"text/javascript\">");
                                                            out.println("alert('User Blocked...');");
                                                            out.println("</script>");  
                                                            out.println("<h3><font color='Green'><b>You are Blocked..</b></font></h3>");
                                                            }
                                                            ...
                                                            out.println("</script>");  
                                                            out.println("<h3><font color='Green'><b>You are Succesfully Registered..</b></font></h3>");
                                                            }
								...
								<ul>
                                                                    <li>
                                                                        <a href="userregistration.jsp" style="color: rgb(0,255,0)"><font color="F9FF33"><b>>Register here</b></font></a></li>
