...
<link rel="stylesheet" type="text/css" href="styles/responsive.css">
	...
	<header class="header">
       ...
       <%
           ...
           ResultSet rs=stm.executeQuery("select * from userdetails where block='yes'");
           if(rs.next()){
             ...
             <table align="center" border="1" height="150" cellspacing="1px" cellpadding="5px" width="700px">
               ...
               <tr><td>&nbsp;&nbsp;<%=id%>&nbsp;&nbsp;</td>
                   <td>&nbsp;&nbsp;<%=name%>&nbsp;&nbsp;</td>
                   <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<%=count%>&nbsp;&nbsp;</td>
                   <td>&nbsp;&nbsp;<a href="unblockuser.jsp?uid=<%=id%>">UnBlock</a></td>
               </tr>
        </table>
           </center>
          <%}else{
out.println("<center>*******no blocked user present********</center>");%><br><br><center><%
}
           %>
           <%
           String msg=request.getParameter("msg");
           if(msg !=null && msg.equals("unblocked"))
           {
           out.println("<h3><font color='Green'>User UnBlocked</font></h3>");    
           }
           if(msg !=null && msg.equals("problem"))
           {
           out.println("<font color='Red'> user cannot be unblocked</font>");    
}%></center>
    </body>
</html>
