...
<link rel="stylesheet" type="text/css" href="styles/responsive.css">
	...
	<header class="header">
       ...
       <%
           ...
           ResultSet rs=stm.executeQuery("select * from userdetails where block='kgcrequest'");
           if(rs.next()){
             ...
             <table align="center" border="1" height="150" cellspacing="1px" cellpadding="5px" width="700px">
               ...
               <tr><td>&nbsp;&nbsp;<%=id%>&nbsp;&nbsp;</td>
                   <td>&nbsp;&nbsp;<%=name%>&nbsp;&nbsp;</td>
                   <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<%=count%>&nbsp;&nbsp;</td>
                   <td>&nbsp;&nbsp;<a href="blockuser.jsp?uid=<%=id%>">Block</a></td>
               </tr>
        </table>
           </center>
          <%}else{
out.println("<center>*******no malicious user present********</center>");%><br><br><center><%
           ...
           if(msg !=null && msg.equals("blocked"))
           {
     out.println("<script type=\"text/javascript\">");
    out.println("alert('UserBlocked..!!');");
    out.println("</script>");      
    out.println("<center><font color='Red'>UserBlocked</font></center>");      
           }
           if(msg !=null && msg.equals("notblocked")){
 out.println("<script type=\"text/javascript\">");
    out.println("alert('User Not Blocked..!!');");
    out.println("</script>");      
    out.println("<center><font color='Red'>User Cannot be Blocked</font></center>");      
           }%></center>
    </body>
</html>
