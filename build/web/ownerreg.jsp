			...
			<div class="container">
				<div class="row">
					<div class="col">
							...
							<div class="home_title">Data Owner Registration</div><br><br>
                                                        <center>                                 
                    <form method="post" action="dataownerreg.jsp">
                       ...
                       <font color="white">Username:<input type="text" size="30" style="height: 25px;" required  placeholder="Enter Username"  name="name"/>
                          ...
                          &nbsp;&nbsp; &nbsp; &nbsp;&nbsp;   Email-Id:<input type="text" size="30" style="height: 25px;" required placeholder="Enter Email-id"  name="emailid"/>                
&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; Mobile Number :<input type="text" required size="30" style="height: 25px;" placeholder="Enter Mobile Number" maxlength="10"  name="mbno" /><br><br> 
  ...
  <option value="Marketing">Marketing</option>
                              ...
                              &nbsp; &nbsp; &nbsp; &nbsp; Sub Department:<select name="subdept" >
  ...
  <option value="Seller">Seller</option>
                            ...
                            <input type="reset" value="Reset" style="height: 25px;width: 90px;"/>
                                                       ...
                                                       <% String msg=request.getParameter("msg");
                                                            ...
                                                            out.println("alert('Owner Succesfully Registered...');");
                                                            out.println("location='dataownerlogin.jsp?msg=regsuccess';");
                                                            out.println("</script>");  
                                                             }
                                                            if(msg !=null && msg.equalsIgnoreCase("failed"))
                                                            {
                                                              out.println("<script type=\"text/javascript\">");
                                                              out.println("alert('Owner Registration Failed...');");
                                                              out.println("location='dataownerlogin.jsp?msg=failed';");
                                                              out.println("</script>");  
