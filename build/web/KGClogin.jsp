			...
			<div class="container">
				<div class="row">
					<div class="col">
							...
							<div class="home_title">KGC Login</div><br>
                                                        <form action="KGCLoginCheck.jsp" method="post">
                                                            <h5 style="color:white">UserName:<input type="text" name="kname"/></h5><br>
                                                            <h5 style="color:white">Password:<input type="password" name="kpass"/></h5><br>
							...
							<div class="breadcrumbs">
								...
								<%
                                                                 ...
                                                                 if(msgg !=null && msgg.equalsIgnoreCase("success"))
                                                                {
                                                                 ...
                                                                 if(msgg!=null && msgg.equalsIgnoreCase("failed"))
                                                                {
                                                                    out.println("<font color='Red'><b>Login Failed,please provide correct details..</b></font>");
                                                                }
                                                                 if(msgg !=null && msgg.equalsIgnoreCase("wrongpassword"))
                                                                {
