	...
	<header class="header">
		...
		<div class="header_container">
			<div class="container">
                ...
                <fieldset>    <center>   <h2><font color='#BE33FF'>Data Owner</font></h2>    
    <table align="center" border="1" cellspacing="1px" cellpadding="10px" height="350px" width="900px">
        ...
        try{
         ...
         <tr>
             ...
             <td>&nbsp;&nbsp;<a href="generatekeys.jsp?oid=<%=oid%>&&email=<%=email%>&&branch=<%=branch%>&&department=<%=department%>&&subdepartment=<%=subdepartment%>&&jobrole=<%=jobrole%>">Generate Key</a></td>
        </tr>
...
{   out.println("<script type=\"text/javascript\">");
    out.println("alert('Owner Activated');");
    out.println("</script>");
    out.println("<font color='Red'>Owner Activated</font>");
}
if(msg !=null && msg.equalsIgnoreCase("notactivated"))
{   out.println("<script type=\"text/javascript\">");
    out.println("alert('Owner Not Activated');");
    out.println("</script>");
    out.println("<font color='Red'>Owner not Activated</font>");
}
%>
